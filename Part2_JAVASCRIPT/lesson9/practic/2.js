...
//     let divS5 = document.createElement('div')
//     divS1.innerText = simpson.name
//     divS2.innerText = simpson.surname
//     divS3.innerText = simpson.age
//     divS4.innerText = simpson.info
//     divS5.innerText = simpson.photo
//     div.append(divS1, divS2, divS3, divS4, divS5)
...
for (const item of coursesArray) {
    ...
    div4.classList.add('modules')
    let ul = document.createElement('ul')
    let list = item.modules
    ...
    div2.innerText = item.monthDuration
    div3.innerText = item.hourDuration
    div.append(div1, div23, div4)
    document.body.append(div)
