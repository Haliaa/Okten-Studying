...
//
// function averageNumber(numbersArr) {
//    let S =numbersArr[0];
//    let averageNum;
//    for (let i = 1; i < numbersArr.length; i++) {
//       let numbersArrElement = numbersArr[i];
...
//
// function randomLimit(sizeOfArray,limit){
//    let array= [];
//    for (let i = 0; i < sizeOfArray; i++) {
